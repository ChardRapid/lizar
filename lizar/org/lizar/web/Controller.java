...
import org.lizar.web.controller.After;
import org.lizar.web.controller.Before;
import org.lizar.web.controller.ContentType;
import org.lizar.web.controller.Event;
import org.lizar.web.controller.EventInterceptor;
import org.lizar.web.controller.EventLoader;
import org.lizar.web.controller.ExceptionRecorder;
import org.lizar.web.controller.JSONHandler;
...
public class Controller implements Lifecycle{
	...
	/**
	 * apply ${cfg:static_resource} config change.
	 */
	...
	public void start() throws Exception{
		...
		if(static_src instanceof Lifecycle) ((Lifecycle)static_src).start();
	...
	public void stop() throws LifecycleException{
		...
		if(static_src instanceof Lifecycle) ((Lifecycle)static_src).stop();
		started=false;
	}
