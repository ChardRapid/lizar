...
//		return param.replaceAll("'", "\"");
	...
	public static String get(String url) throws IOException {
		...
		HttpURLConnection httpConn = (HttpURLConnection) netUrl
				.openConnection();
		httpConn.connect();
		String encode_type=get_encode_type(httpConn.getHeaderField("content-type"), "utf-8");
		System.out.println("encode - "+encode_type);
		System.out.println("encode - "+httpConn.getContentType());
	...
	public static String post(String url, Map<String, String> param, int timeout)
		...
		while (in.read(b) >= 0) {
			content.append(new String(b,
					get_encode_type(conn.getHeaderField("content-type"), "utf-8")));
		}
		return content.toString();
	}
...
//		System.out.println(post("http://tieba.baidu.com/index.html","",1000));
		System.out.println(get_encode_type("text/html", "utf-8"));
	}
