...
import com.lizar.exception.CellKeyIsNotJsonObject;
import com.lizar.exception.ConfigKeyLoopTooDeep;
import com.lizar.exception.ConfigKeysPathIllegal;
import com.lizar.exception.CoreConfigJsonIsNull;
import com.lizar.exception.InvalidConfigKeyExpress;
...
public class Config {
	...
	private void check_server_info(JSON entity){
		String encode_type=xpath_str("server_info.encode_type","utf-8");
	 ...
	 */
	private static Object express(String e){
		if(StringHelper.isNull(e))return null;
		int i=0;
		Object o;
		String k=e.toString();
		while(true){
			if(i>=20){
				throw new ConfigKeyLoopTooDeep(FILE_PATH,e);
			}
			i++;
	...
	private void _init_plugin_config(){
		...
		File f=new File(path_filter(PluginManager.DIR));
