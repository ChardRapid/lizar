...
public class QueryBuilder {
    ...
    public QueryBuilder withinCenter( double x , double y , double radius ){
        addOperand( "$within" , 
                    new MEntity( "$center" , new Object[]{ new Double[]{ x , y } , radius } ) );
        return this;
    }
    ...
    public QueryBuilder withinBox(double x, double y, double x2, double y2) {
    	addOperand( "$within" , 
                    new MEntity( "$box" , new Object[] { new Double[] { x, y }, new Double[] { x2, y2 } } ) );
    	return this;
    }
    ...
    public QueryBuilder or( Entity ... ors ){
    ...
    private void addOperand(String op, Object value) {
        ...
        MEntity operand;
        if(!(storedValue instanceof Entity)) {
            operand = new MEntity();
            _query.put(_currentKey, operand);
        } else {
            operand = (MEntity)_query.get(_currentKey);
        }
