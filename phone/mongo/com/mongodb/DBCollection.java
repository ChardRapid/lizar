...
public abstract class DBCollection {
     ...
     * @dochub insert
     */
    public WriteResult insert(Entity[] arr , WriteConcern concern ) throws MongoException {
     ...
     * @dochub insert
     */
    public abstract WriteResult insert(Entity[] arr , WriteConcern concern, DBEncoder encoder) throws MongoException;
     ...
     * @dochub insert
     */
    public WriteResult insert(Entity o , WriteConcern concern )
        throws MongoException {
        return insert( new Entity[]{ o } , concern );
    }
     ...
     * @dochub insert
     */
    public WriteResult insert(Entity ... arr)
        throws MongoException {
     ...
     * @dochub insert
     */
    public WriteResult insert(WriteConcern concern, Entity ... arr)
        throws MongoException {
     ...
     * @dochub insert
     */
    public WriteResult insert(List<Entity> list )
        throws MongoException {
     ...
     * @dochub insert
     */
    public WriteResult insert(List<Entity> list, WriteConcern concern )
            throws MongoException {
        return insert( list.toArray( new Entity[list.size()] ) , concern );
    }
     ...
     * @dochub update
     */
    public WriteResult update( Entity q , Entity o , boolean upsert , boolean multi , WriteConcern concern ) throws MongoException {
     ...
     * @dochub update
     */
    public abstract WriteResult update( Entity q , Entity o , boolean upsert , boolean multi , WriteConcern concern, DBEncoder encoder ) throws MongoException ;

    /**
     * calls {@link DBCollection#update(com.mongodb.Entity, com.mongodb.Entity, boolean, boolean, com.mongodb.WriteConcern)} with default WriteConcern.
     * @param q search query for old object to update
     * @param o object with which to update <tt>q</tt>
     * @param upsert if the database should create the element if it does not exist
     ...
     * @dochub update
     */
    public WriteResult update( Entity q , Entity o , boolean upsert , boolean multi )
        throws MongoException {
        return update( q , o , upsert , multi , getWriteConcern() );
    }

    /**
     * calls {@link DBCollection#update(com.mongodb.Entity, com.mongodb.Entity, boolean, boolean)} with upsert=false and multi=false
     * @param q search query for old object to update
     * @param o object with which to update <tt>q</tt>
     * @return
     * @throws MongoException
     * @dochub update
     */
    public WriteResult update( Entity q , Entity o ) throws MongoException {
        return update( q , o , false , false );
    }

    /**
     * calls {@link DBCollection#update(com.mongodb.Entity, com.mongodb.Entity, boolean, boolean)} with upsert=false and multi=true
     * @param q search query for old object to update
     * @param o object with which to update <tt>q</tt>
     * @return
     * @throws MongoException
     * @dochub update
     */
    public WriteResult updateMulti( Entity q , Entity o ) throws MongoException {
     ...
     */
    protected abstract void doapply( Entity o );
     ...
     * @dochub remove
     */
    public WriteResult remove( Entity o , WriteConcern concern ) throws MongoException {
     ...
     * @dochub remove
     */
    public abstract WriteResult remove( Entity o , WriteConcern concern, DBEncoder encoder ) throws MongoException ;

    /**
     * calls {@link DBCollection#remove(com.mongodb.Entity, com.mongodb.WriteConcern)} with the default WriteConcern
     * @param o the object that documents to be removed must match
     * @return
     * @throws MongoException
     * @dochub remove
     */
    public WriteResult remove( Entity o )
        throws MongoException {
     ...
     * Finds objects
     */
    abstract Iterator<Entity> __find( Entity ref , Entity fields , int numToSkip , int batchSize , int limit, int options, ReadPreference readPref, DBDecoder decoder ) throws MongoException ;

    /**
     * Calls {@link DBCollection#find(com.mongodb.Entity, com.mongodb.Entity, int, int)} and applies the query options
     ...
     */
    @Deprecated
    public final DBCursor find( Entity query , Entity fields , int numToSkip , int batchSize , int options ) throws MongoException{
     ...
     */
    @Deprecated
    public final DBCursor find( Entity query , Entity fields , int numToSkip , int batchSize ) {
     ...
     * @throws MongoException
     */
    public final Entity findOne( Object obj )
        throws MongoException {
     ...
     * @dochub find
     */
    public final Entity findOne( Object obj, Entity fields ) {
        Iterator<Entity> iterator = __find(new MEntity("_id", obj), fields, 0, -1, 0, getOptions(), getReadPreference(), _decoderFactory.create() );
     ...
     * @return the document
     */
    public Entity findAndModify(Entity query, Entity fields, Entity sort, boolean remove, Entity update, boolean returnNew, boolean upsert) {

        MEntity cmd = new MEntity( "findandmodify", _name);
    ...
    /**
     * calls {@link DBCollection#findAndModify(com.mongodb.Entity, com.mongodb.Entity, com.mongodb.Entity, boolean, com.mongodb.Entity, boolean, boolean)}
     ...
     */
    public Entity findAndModify( Entity query , Entity sort , Entity update){
     ...
     * @return the old document
     */
    public Entity findAndModify( Entity query , Entity update ) {
     ...
     */
    public Entity findAndRemove( Entity query ) {
    ...
    /**
     * calls {@link DBCollection#createIndex(com.mongodb.Entity, com.mongodb.Entity)} with default index options
     * @param keys an object with a key set of the fields desired for the index
     * @throws MongoException
     */
    public final void createIndex( final Entity keys )
        throws MongoException {
     ...
     * @throws MongoException
     */
    public void createIndex( Entity keys , Entity options ) throws MongoException {
     ...
     * @throws MongoException
     */
    public abstract void createIndex( Entity keys , Entity options, DBEncoder encoder ) throws MongoException;
    ...
    public final void ensureIndex( final String name ){
        ensureIndex( new MEntity( name , 1 ) );
    }

    /**
     * calls {@link DBCollection#ensureIndex(com.mongodb.Entity, com.mongodb.Entity)} with default options
     * @param keys an object with a key set of the fields desired for the index
     * @throws MongoException
     */
    public final void ensureIndex( final Entity keys )
        throws MongoException {
        ensureIndex( keys , defaultOptions( keys ) );
    }

    /**
     * calls {@link DBCollection#ensureIndex(com.mongodb.Entity, java.lang.String, boolean)} with unique=false
     * @param keys fields to use for index
     * @param name an identifier for the index
     * @throws MongoException
     * @dochub indexes
     */
    public void ensureIndex( Entity keys , String name )
        throws MongoException {
     ...
     * @throws MongoException
     */
    public void ensureIndex( Entity keys , String name , boolean unique )
        throws MongoException {
        Entity options = defaultOptions( keys );
     ...
     * @throws MongoException
     */
    public final void ensureIndex( final Entity keys , final Entity optionsIN )
        throws MongoException {

        if ( checkReadOnly( false ) ) return;

        final Entity options = defaultOptions( keys );
    ...
    Entity defaultOptions( Entity keys ){
        Entity o = new MEntity();
     ...
     */
    public static String genIndexName( Entity keys ){
     ...
     */
    public void setHintFields( List<Entity> lst ){
        _hintFields = lst;
    }
     ...
     * @dochub find
     */
    public final DBCursor find( Entity ref ){
     ...
     * @dochub find
     */
    public final DBCursor find( Entity ref , Entity keys ){
     ...
     * @throws MongoException
     */
    public final Entity findOne()
        throws MongoException {
        return findOne( new MEntity() );
    }
     ...
     * @throws MongoException
     */
    public final Entity findOne( Entity o )
        throws MongoException {
     ...
     * @dochub find
     */
    public final Entity findOne( Entity o, Entity fields ) {
     ...
     * @dochub find
     */
    public final Entity findOne( Entity o, Entity fields, ReadPreference readPref ) {
        Iterator<Entity> i = __find( o , fields , 0 , -1 , 0, getOptions(), readPref, _decoderFactory.create() );
        Entity obj = (i == null ? null : i.next());
    ...
    /**
     * calls {@link DBCollection#apply(com.mongodb.Entity, boolean)} with ensureID=true
     * @param o <code>DBObject</code> to which to add fields
     * @return the modified parameter object
     */
    public final Object apply( Entity o ){
        return apply( o , true );
    }

    /**
     * calls {@link DBCollection#doapply(com.mongodb.Entity)}, optionally adding an automatic _id field
     ...
     */
    public final Object apply( Entity jo , boolean ensureID ){
    ...
    /**
     * calls {@link DBCollection#save(com.mongodb.Entity, com.mongodb.WriteConcern)} with default WriteConcern
     * @param jo the <code>DBObject</code> to save
     *        will add <code>_id</code> field to jo if needed
     * @return
     */
    public final WriteResult save( Entity jo ) {
     ...
     * @throws MongoException
     */
    public final WriteResult save( Entity jo, WriteConcern concern )
        throws MongoException {
    ...
    public void dropIndexes( String name )
        throws MongoException {
        Entity cmd = BasicDBObjectBuilder.start()
    ...
    public long count()
        throws MongoException {
        return getCount(new MEntity(), null);
    }
     ...
     * @throws MongoException
     */
    public long count(Entity query)
        throws MongoException {
    ...
    /**
     *  calls {@link DBCollection#getCount(com.mongodb.Entity, com.mongodb.Entity)} with an empty query and null fields.
    ...
    /**
     *  calls {@link DBCollection#getCount(com.mongodb.Entity, com.mongodb.Entity)} with null fields.
     *  @param query query to match
     *  @return
     * @throws MongoException
     */
    public long getCount(Entity query)
        throws MongoException {
        return getCount(query, null);
    }

    /**
     *  calls {@link DBCollection#getCount(com.mongodb.Entity, com.mongodb.Entity, long, long)} with limit=0 and skip=0
     *  @param query query to match
     *  @param fields fields to return
     *  @return
     * @throws MongoException
     */
    public long getCount(Entity query, Entity fields)
        throws MongoException {
     ...
     * @throws MongoException
     */
    public long getCount(Entity query, Entity fields, long limit, long skip )
        throws MongoException {
    ...
    /**
     * calls {@link DBCollection#group(com.mongodb.Entity, com.mongodb.Entity, com.mongodb.Entity, java.lang.String, java.lang.String)} with finalize=null
     * @param key - { a : true }
     ...
     */
    public Entity group( Entity key , Entity cond , Entity initial , String reduce )
        throws MongoException {
     ...
     * @see <a href="http://www.mongodb.org/display/DOCS/Aggregation">http://www.mongodb.org/display/DOCS/Aggregation</a>
     */
    public Entity group( Entity key , Entity cond , Entity initial , String reduce , String finalize )
        throws MongoException {
     ...
     * @see <a href="http://www.mongodb.org/display/DOCS/Aggregation">http://www.mongodb.org/display/DOCS/Aggregation</a>
     */
    public Entity group( GroupCommand cmd ) {
        CommandResult res =  _db.command( cmd.toDBObject(), getOptions() );
        res.throwOnError();
        return (Entity)res.get( "retval" );
    }
     ...
     */
    @Deprecated
    public Entity group( Entity args )
        throws MongoException {
        args.put( "ns" , getName() );
        CommandResult res =  _db.command( new MEntity( "group" , args ), getOptions() );
        res.throwOnError();
        return (Entity)res.get( "retval" );
    }
    ...
    public List distinct( String key ){
        return distinct( key , new MEntity() );
    }
     ...
     * @return
     */
	public List distinct( String key , Entity query ){
        Entity c = BasicDBObjectBuilder.start()
     ...
     * @dochub mapreduce
     */
    public MapReduceOutput mapReduce( String map , String reduce , String outputTarget , Entity query ) throws MongoException{
     ...
     * @dochub mapreduce
     */
    public MapReduceOutput mapReduce( String map , String reduce , String outputTarget , MapReduceCommand.OutputType outputType , Entity query )
            throws MongoException{
     ...
     * @throws MongoException
     */
    public MapReduceOutput mapReduce( Entity command ) throws MongoException{
     ...
     */
    public List<Entity> getIndexInfo() {
        MEntity cmd = new MEntity();
     ...
     * @throws MongoException
     */
    public void dropIndex( Entity keys )
        throws MongoException {
    ...
    public CommandResult getStats() {
        return getDB().command(new MEntity("collstats", getName()), getOptions());
    }
    ...
    protected Entity _checkObject( Entity o , boolean canBeNull , boolean query ){
        if ( o == null ){
            if ( canBeNull )
                return null;
     ...
     */
    private void _checkKeys( Entity o ) {
        for ( String s : o.keySet() ){
            validateKey ( s );
            Object inner = o.get( s );
            if ( inner instanceof Entity ) {
                _checkKeys( (Entity)inner );
    ...
    protected List<Entity> _hintFields;
