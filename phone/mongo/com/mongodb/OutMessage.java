...
class OutMessage extends BasicBSONEncoder {
    ...
    static OutMessage query( Mongo m , int options , String ns , int numToSkip , int batchSize , Entity query , Entity fields ){
        return query( m, options, ns, numToSkip, batchSize, query, fields, ReadPreference.PRIMARY );
    }

    static OutMessage query( Mongo m , int options , String ns , int numToSkip , int batchSize , Entity query , Entity fields, ReadPreference readPref ){
        return query( m, options, ns, numToSkip, batchSize, query, fields, readPref, DefaultDBEncoder.FACTORY.create());
    }

    static OutMessage query( Mongo m , int options , String ns , int numToSkip , int batchSize , Entity query , Entity fields, ReadPreference readPref, DBEncoder enc ){
    ...
    private void _appendQuery( int options , String ns , int numToSkip , int batchSize , Entity query , Entity fields, ReadPreference readPref){
