...
public class GroupCommand {
    ...
    public GroupCommand(DBCollection inputCollection, Entity keys, Entity condition, Entity initial, String reduce, String finalize) {
