...
public class GridFS {
    ...
    public DBCursor getFileList(){
        return _filesCollection.find().sort(new MEntity("filename",1));
    }
     ...
     * @return cursor of file objects
     */
    public DBCursor getFileList( Entity query ){
        return _filesCollection.find( query ).sort(new MEntity("filename",1));
    }
    ...
    public GridFSDBFile findOne( ObjectId id ){
        return findOne( new MEntity( "_id" , id ) );
    }
    /**
    ...
    public GridFSDBFile findOne( String filename ){
        return findOne( new MEntity( "filename" , filename ) );
    }
    /**
     ...
     * @return
     */
    public GridFSDBFile findOne( Entity query ){
    ...
    public List<GridFSDBFile> find( String filename ){
        return find( new MEntity( "filename" , filename ) );
    }
    /**
     ...
     * @return
     */
    public List<GridFSDBFile> find( Entity query ){
    ...
    public void remove( ObjectId id ){
        _filesCollection.remove( new MEntity( "_id" , id ) );
        _chunkCollection.remove( new MEntity( "files_id" , id ) );
    }
    ...
    public void remove( String filename ){
        remove( new MEntity( "filename" , filename ) );
    }
     ...
     * @param query
     */
    public void remove( Entity query ){
