 ...
 * @author antoine
 */
public abstract class GridFSFile implements Entity {
    ...
    public void validate() throws MongoException {
        ...
        Entity cmd = new MEntity( "filemd5" , _id );
        cmd.put( "root" , _fs._bucketName );
        Entity res = _fs._db.command( cmd );
    ...
    public Entity getMetaData(){
        return (Entity)_extradata.get( "metadata" );
    }
     ...
     * @return
     */
    public void setMetaData(Entity metadata){
