...
public class ReplicaSetStatus {
     ...
     */
    ServerAddress getASecondary( Entity tags ){
    ...
    static class Node {
        ...
        synchronized void update(Set<Node> seenNodes){
            try {
                ...
                _ok = true;
                _isMaster = res._bool( "ismaster" , false );
                _isSecondary = res._bool( "secondary" , false );
                _lastPrimarySignal.set( res._string( "primary" ) );
                ...
                if (res.containsField( "tags" )) {
                    Entity tags = (Entity) res.get( "tags" );
                    for ( String key : tags.keySet() ) {
    ...
    static final Entity _isMasterCmd = new MEntity( "ismaster" , 1 );
