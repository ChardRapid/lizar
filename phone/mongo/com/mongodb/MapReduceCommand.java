...
public class MapReduceCommand {
     ...
     * @dochub mapreduce
     */
    public MapReduceCommand(DBCollection inputCollection , String map , String reduce , String outputCollection, OutputType type, Entity query) throws MongoException {
     ...
     */
    public void setSort( Entity sort ){
        _sort = sort;
    }
